...
acf_add_local_field_group( array(
    ...
    acf_add_local_field_group( array(
            'key'                   => 'group_4e67afaf95jkac17',
            'title'                 => 'CE: Header-2col',
            'fields'                => array(
                   array(
                    'key'               => 'field_4e67ae98c1lfe2',
                    'label'             => 'Header Text',
                    'name'              => 'header_text',
                    'type'              => 'wysiwyg',
                    'instructions'      => '',
	...
	acf_add_local_field_group( array(
		...
		'fields'                => array(
			array(
				...
				'layouts'           => array(
                    'layout_5e67adcb88dc36' => array(
						'key'        => 'layout_5e67adcb88dc36',
						'name'       => 'header-2col',
						'label'      => 'Header-2col',
						'display'    => 'block',
						'sub_fields' => array(
							array(
								'key'               => 'field_5e67a0dd214069c',
								'label'             => 'Header-2col',
								'name'              => 'header-2col',
								'type'              => 'clone',
								'instructions'      => '',
